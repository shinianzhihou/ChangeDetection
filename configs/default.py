...
_C.BUILD.DATALOADER.CHOICE = "ISPRS"
...
_C.BUILD.LR_SCHEDULER.CHOICE = "WarmupCosineLR"
## Tools
_C.BUILD.USE_CHECKPOINT = False
_C.BUILD.USE_TENSORBOARD = False
_C.BUILD.TEST_WHEN_TRAIN = False
...
_C.DATALOADER.TEST_BATCH_SIZE = 1
_C.DATALOADER.NUM_WORKERS = 0
_C.DATALOADER.SHUFFLE = True
_C.DATALOADER.TEST_SHUFFLE = False
...
_C.EVAL.SAVE_PATH = ""
_C.EVAL.SAVE_NAME = ""
_C.EVAL.SAVE_IMAGES = False
_C.EVAL.SAVE_BY_METRIC = "F1"
_C.EVAL.SAVE_IMAGE_ROOT = "logs/imgs"
...
_C.SOLVER.LR_SCHEDULER.MAX_ITERS = 10000
_C.SOLVER.LR_SCHEDULER.LAST_EPOCH = -1
### Warmup
_C.SOLVER.LR_SCHEDULER.WARMUP_FACTOR = 0.001
_C.SOLVER.LR_SCHEDULER.WARMUP_ITERS = 1000
_C.SOLVER.LR_SCHEDULER.WARMUP_METHOD = "linear" # or constant
