...
# we directly use v6 for building the benchmark
"""
...
class ChangeFormerV6(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False, embed_dim=256, name='changeformer'):
    ...
    def forward(self, x1, x2):
        ...
        # FIXME(shinian) fix the training process with multi-output
