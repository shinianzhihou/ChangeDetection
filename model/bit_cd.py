...
###############################################################################
# Helper Functions in help_funcs.py
###############################################################################
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    if args.net_G == 'base_resnet18':
        net = BaseResNet(input_nc=3, output_nc=2, output_sigmoid=False)
...
class BASE_Transformer(BaseResNet):
    """
...
if __name__ == "__main__":
    ...
    for func in [base_resnet18, base_transformer_pos_s4, base_transformer_pos_s4_dd8, base_transformer_pos_s4_dd8_dedim8]:
        model = func()
